-- ============================================
-- Mio Bakery - MySQL Initialization Script
...
-- Products
INSERT INTO products (name, subtitle, description, price, original_price, image, category_id, tags, specs, is_hot, is_new, sales) VALUES
...
-- Banners
INSERT INTO banners (image, title, link, sort_order) VALUES
('https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=800', '春季新品上市', '/category?tag=season', 1),
('https://images.unsplash.com/photo-1558301211-0d8c8ddee6ec?w=800', '手工定制蛋糕', '/category', 2),
('https://images.unsplash.com/photo-1542826438-bd32f43d626f?w=800', '会员专享优惠', '/coupons', 3);

-- Coupons
INSERT INTO coupons (name, type, value, min_amount, total, end_date) VALUES
